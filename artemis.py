...
class Artemis(object):
    def __init__(self):
        ...
        self.stdout_path = '/var/artemis-client/logs/artemis_out.log'
        self.stderr_path = '/var/artemis-client/logs/artemis_err.log'
        self.pidfile_path = '/var/artemis-client/pid/client.pid'
        self.pidfile_timeout = 5
        self.logfile = '/var/artemis-client/logs/client.log'
        self.config_file = '/var/artemis-client/config/config.conf'
        self.thug_config = '/etc/thug/logging.conf'
        self.feeds = 'artemis.urls'
        self.hpc = None
...
if __name__ == '__main__':
    ...
    if not os.path.exists("/var/artemis-client"):
        shutil.copytree(template,"/var/artemis-client")
